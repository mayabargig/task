...
export default function NavBar() { 
  ...
  return (
    <>
        <Disclosure as="nav" className="bg-gray-800 min-h-full dark:text-white dark:bg-black">
          {({ open }) => (
            <>
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8  dark:text-white dark:bg-black">
                <div className="flex h-16 items-center justify-between  dark:text-white dark:bg-black">
                  <div className="flex items-center  dark:text-white dark:bg-black">
                  <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8  dark:text-white dark:bg-black">
                    <h1 className="text-3xl font-bold tracking-tight text-white dark:text-white dark:bg-black">Pet Zone</h1>
                  </div>
                    <div className="flex-shrink-0  dark:text-white dark:bg-black">
                      <img
                        className="h-10 w-10 rounded-full text-white  dark:text-white dark:bg-black "
                        src={LogoPetZone}
                        alt="Your Company"
                      />
                    </div>
                  ...
                  <div className="hidden md:block">
                        <span className="h-5 w-5 space-x-2" aria-hidden="true">
                        </span>
                  ...
                  <div className="-mr-2 flex md:hidden  dark:text-white dark:bg-black">
              ...
              <Disclosure.Panel className="md:hidden">
                <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3  dark:text-white dark:bg-black">
                  {navigation.map((item) => (
                    <Disclosure.Button
                    key={item.name}
                    as="a"
