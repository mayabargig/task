...
const GetUserInfo: React.FC = ({user}) => {
...
<div className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900  dark:text-white dark:bg-black border-solid border-white border-2 ">
    ...
    <div className="text-center mt-2">
        <h2 className="font-semibold  dark:text-white dark:bg-black"> {user.firstName} {user.lastName}</h2>
        <p className="text-gray-500 font-semibold  dark:text-white dark:bg-black">{user.email}</p>
    </div>
    <ul className="py-4 mt-2 text-gray-700 flex items-center justify-around  dark:text-white dark:bg-black">
        <li className="flex flex-col items-center justify-around">
            ...
            <div className="font-semibold m-0  dark:text-white dark:bg-black">{user.address?.city}
            </div>
            <span className="text-gray-500mt-0 mt-0 text-sm  dark:text-white dark:bg-black">{user.address?.street}</span>
        </li>
        ...
        <PhoneArrowDownLeftIcon className="h-5 w-5 text-black-500" />
            <div className="font-semibold  dark:text-white dark:bg-black">{user.phoneNumber}</div>
        </li>
        <li className="flex flex-col items-center justify-around  dark:text-white dark:bg-black">
            ...
            <div className="font-semibold  dark:text-white dark:bg-black">{user.userName}</div>
        </li>
    </ul>
    </div>
  )
